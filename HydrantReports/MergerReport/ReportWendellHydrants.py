...
try:
    ...
    town = sys.argv[0]
    selectarea = os.path.join(os.path.dirname(sys.argv[0]),r"MergerAreas.gdb\wendell")
    ...
    filepath = os.path.join(os.path.dirname(sys.argv[0]),"wendell_export_"+stamp+".csv")
