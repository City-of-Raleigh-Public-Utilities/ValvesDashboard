...
try:
    ...
    town = sys.argv[0]
    selectarea = os.path.join(os.path.dirname(sys.argv[0]),r"MergerAreas.gdb\rolesville")
    ...
    filepath = os.path.join(os.path.dirname(sys.argv[0]),"rolesville_export_"+stamp+".csv")
