...
try:
    ...
    town = sys.argv[0]
    selectarea = os.path.join(os.path.dirname(sys.argv[0]),r"MergerAreas.gdb\zebulon")
    ...
    filepath = os.path.join(os.path.dirname(sys.argv[0]),"zebulon_export_"+stamp+".csv")
