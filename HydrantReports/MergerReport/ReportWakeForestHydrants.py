...
def selectTown(town):
    ...
    rows = arcpy.SearchCursor(selection,"REPAIRNEED = 1 OR OPERABLE = 'N'","", "STNUM, STENUM,STPREFIX, STNAME, STTYPE, STSUFFIX, OWNEDBY, MANUFACTURER, HYDRANTYEAR, VALVESIZE, PUMPERNOZZLETYPE, SIDENOZZLETYPE, OPERABLE, REPAIRNEED, NOTES, JURISID, CHECKED, RFDSTATION, EDITEDON","EDITEDON A")
    ...
    if town == 'wakeforest':
        SendMail(filepath, True, "See attached file for hydrants that are inoperable and/or need repair","gis@raleighnc.gov,Colleen.Sharpe@raleighnc.gov,Carl.Stearns@raleighnc.gov,Anthony.Vogt@raleighnc.gov,Whit.Wheeler@raleighnc.gov,Kelly.Phillips@raleighnc.gov,Ken.Best@raleighnc.gov,Elvis.Medlin@raleighnc.gov,David.Woodlief@raleighnc.gov,Jeremy.Isgrigg@raleighnc.gov","Wake Forest Hydrant Report")
    elif town == 'zebulon':
        SendMail(filepath, True, "See attached file for hydrants that are inoperable and/or need repair","Colleen.Sharpe@raleighnc.gov,gis@raleighnc.gov,Carl.Stearns@raleighnc.gov,Anthony.Vogt@raleighnc.gov,Whit.Wheeler@raleighnc.gov,Edward.Smith@raleighnc.gov,Ken.Best@raleighnc.gov,David.Johnson@raleighnc.gov","Zebulon Hydrant Report")
    elif town == 'wendell':
        SendMail(filepath, True, "See attached file for hydrants that are inoperable and/or need repair","Colleen.Sharpe@raleighnc.gov,gis@raleighnc.gov,Carl.Stearns@raleighnc.gov,Anthony.Vogt@raleighnc.gov,Whit.Wheeler@raleighnc.gov,Edward.Smith@raleighnc.gov,Ken.Best@raleighnc.gov,David.Johnson@raleighnc.gov","Wendell Hydrant Report")
    elif town == 'garner':
    ...
    elif town == 'rolesville':
        SendMail(filepath, True, "See attached file for hydrants that are inoperable and/or need repair","gis@raleighnc.gov,Anthony.Vogt@raleighnc.gov,Whit.Wheeler@raleighnc.gov,Michael.Gutekunst@raleighnc.gov,Ken.Best@raleighnc.gov,Elvis.Medlin@raleighnc.gov,Kenneth.Neal@raleighnc.gov,Colleen.Sharpe@raleighnc.gov","Rolesville Hydrant Report")
...
try:
    ...
    townList = ['rolesville', 'wakeforest', 'garner', 'wendell', 'zebulon']
    for t in townList:
        selectTown(t)
